...
cocktail.mix({
  ...
  constructor: function (options) {
     ...
     * @public
     * @method addPlugin 
     * @param plugin {Object} the plugin to be added to the list. It must be an Object with 
     * match() and transform() methods.
     */
      ...
      try {
        ...
        for (var i = patterns.length - 1; i >= 0; i -= 1) {
          var context = {
            ...
            me.executePluginsInContext(plugins, context, opts);
